...
export default function EventEditor({ event, onSave }) {
    ...
    return (
        <div>
            ...
            <TextArea labelText="Description" value={savedEvent.description} onChage={e => setSavedEvent({ ...savedEvent, description: e.target.value })} />
            ...
            <p>{savedEvent?.address?.address}</p>
